        ...
        <div className={styles.section_content}>
          <div className={styles.content}>
            ...
            <div className={styles.content_block}>
              ...
              {/* ShowMoreComponent content end */}
              <p className={styles.content_text}>
                <span className='semibold-italic'>NOTE:</span> There are legitimate concerns about the safety and long-term viability of the Dextronix Nitinol LE product for veterinary use:
              </p>
