    ...
    <>
      ...
      <section className={styles.section}>
        <div className={styles.section_content}>
          <div className={styles.content}>
            <div className={styles.heading}>
              {/* <hr /> */}
              <h1 className={styles.heading_head}>Use Cases For <span className='mobile-show-inline'><br /></span>Laryngeal Stents in Dogs
              </h1>
        ...
        <DvmsNav />
            ...
            {/* Stenting vs. Surgery Content Start */}
            <div className={styles.content_block}>
                  ...
                  <ShowMoreContent
                    ...
                    >
                     <div className={styles.showmore_content_block}>
                      ...
                      <span className={styles.showmore_content_space}></span>
                      <p className={styles.showmore_content_text}>Silicone laryngeal stents are useful to primary veterinarians and internists because they require no specialized skills and can be implanted with readily-available standard forceps. </p>
