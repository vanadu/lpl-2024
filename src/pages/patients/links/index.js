      ...
      <section className={styles.section}>
        <div className={styles.section_content}>
          <div className={styles.heading}>
            <h1 className={styles.heading_head}>Links to Larygneal Paralysis <span className='mobile-show-inline'><br/></span> Research and Websites
            </h1>
            <h2 className={styles.heading_subhead}>Research Studies and Info<span className="mobile-hide-inline">rmation</span> about <span className='mobile-show-inline'><br /></span>Lar Par and GOLPP in Dogs</h2>
            <SkipThis />
          </div>
        </div>
