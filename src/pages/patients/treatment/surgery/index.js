          ...
          <div className={styles.section_content}>
            <div className={styles.content}>
              <div className={styles.
                heading}>
                <h1 className={styles.heading_head}>Lar Par Surgery for Dogs: Types, Risk Factors and Background
                </h1>
                <h2 className={styles.heading_subhead}>Surgical Treatment Options for<span className='mobile-hide-inline'>&nbsp;Canine</span>&nbsp;Laryngeal&nbsp;Paralysis</h2>
              </div>
            </div>
          </div>
