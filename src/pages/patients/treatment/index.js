        ...
        <div className={styles.section_content}>
          <div className={styles.two_column_content}>
            <div className={styles.heading}>
              {/* <hr /> */}
              <h1 className={styles.heading_head}>Treatment Options for <span className='mobile-show-inline'><br /></span>Laryngeal Paralysis in Dogs</h1>
              <h2 className={styles.heading_subhead}>Veterinary-Medical Treatment vs. Managing Lar Par Symptoms
              </h2>
              {/* <hr /> */}
            </div>
          </div>
