        ...
        <div className={styles.section_content}>
          <div className={styles.content}>
            <div className={styles.heading}>
              <h1 className={styles.heading_head}>Stent Types for <span className='mobile-show-inline'><br /></span>Laryngeal Paralysis in Dogs
              </h1>
              <h2 className={styles.heading_subhead}>Silicone Stents vs. <span className='mobile-show-inline'><br /></span>Nitinol Wire Stents</h2>
            </div>
